...
lint: ## check style with flake8
	flake8 acdh-arche-pyutils tests
...
coverage: ## check code coverage quickly with the default Python
	coverage run --source acdh-arche-pyutils -m pytest
	coverage report -m
	coverage html
	$(BROWSER) htmlcov\index.html

docs: ## generate Sphinx HTML documentation, including API docs
	del /f /q docs\acdh-arche-pyutils.rst
	del /f /q docs\modules.rst
	sphinx-apidoc -o docs acdh-arche-pyutils
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
