...
from acdh_arche_pyutils.utils import camel_to_snake, create_query_sting, id_from_uri


class ArcheApiClient:
    """Main Class to interact with ARCHE-API"""

    def __init__(self, arche_endpoint, out_dir="."):
    ...
    def get_resource(self, res_uri, format="nt"):
        ...
        print(
            f"fetching and parsing data for URI: {res_uri}, calling endpoint \n {url}"
        )
    ...
    def write_resource_to_file(self, res_uri, format="nt"):
        ...
        g.serialize(save_path, format=format, encoding="utf-8")
        return save_path
